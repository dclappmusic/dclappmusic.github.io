<template>
  <div class="modal subir_form">
    <div class="sub_modal">
      ...
      <div v-else>
        <p>Vale, te hemos mandao un email, cierra esta pestaña y sigue desde la que te abrirá el link del email</p>
      </div>
      <button :disabled="!email || !preaction" class="boton cta" @click="autenticate">entrar</button>
    </div>
  </div>
</template>
